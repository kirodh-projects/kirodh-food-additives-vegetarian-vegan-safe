...
Usage:
    python -m src.food_additives.build_database [--force] [--db-path PATH] [--data-dir DIR]
"""
...
from src.food_additives.e_ins_mapper import build_e_to_ins_map
...
from src.food_additives.web_scraper import scrape_supplementary_data
from src.shared.config import get_data_dir
