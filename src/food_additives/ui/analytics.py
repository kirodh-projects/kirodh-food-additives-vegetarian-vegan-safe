...
from src.food_additives.queries import get_analytics_summary, get_category_vegan_breakdown, get_dangerous_additives
from src.food_additives.ui.charts import (
    HALAL_COLORS,
    ORIGIN_COLORS,
    SAFETY_COLORS,
    VEGAN_COLORS,
